...
public interface IStubManager {
	...
	public JSONObject getServicePlanGUID(String token, String apiurl, String serviceguid,String login_url) throws MyException;
	...
	public JSONObject getOrganisations(String token, String appurl,String login_url) throws MyException;

	public JSONObject getRegions(String regions) throws MyException;

	public JSONObject getSpace(String token, String appurl, String orgguid,String login_url) throws MyException;

	public JSONObject checkAppName(String token, String apiurl, String spaceguid, String appname,String login_url) throws MyException;
}