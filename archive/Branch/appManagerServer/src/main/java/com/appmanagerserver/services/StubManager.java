...
@Override
public JSONObject getServicePlanGUID(final String token,final String apiurl,final String serviceguid) throws MyException {
	String  output= paasCatalog.getServicePlanGUID(token,apiurl,serviceguid);
	return  AppUtils.getInstance().toJson(output);
}

@Override
public JSONObject getExistingInstances(final String token,final String apiurl,final String serviceguid) throws MyException {
	String  output= paasCatalog.getExistingInstances(token,apiurl,serviceguid);
	return  AppUtils.getInstance().toJson(output);
}

@Override
public JSONObject getOrganisations(final String token,final String appurl) throws MyException {
...
@Override
public JSONObject getSpace(final String token,final String appurl,final String orgguid) throws MyException {
...
@Override
public JSONObject checkAppName(final String token,final String apiurl,final String spaceguid,final String appname) throws MyException {
