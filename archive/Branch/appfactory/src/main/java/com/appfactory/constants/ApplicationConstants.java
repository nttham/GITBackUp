...
public class ApplicationConstants {
	...
	public static final String CREATED_MICRO_SERVICE_APP = "Micro Service app is created";
	public static final String EXISTING_MICRO_SERVICE_APP = "Existing Micro Service app is created";
	public static final String NEW_MICRO_SERVICE_APP = "New Micro Service app is created";
	...
	public static final String CREATED_MICRO_SERVICE_APP_LOGGER="Micro Service App is created for Logger";
	public static final String CREATING_SERVICE_INSTANCE_LOGGER="Error in creating the Service Instance";
	public static final String DBNAME = "mongodb";
	/**
	 ...
	 */
	public static final String ENVIRONMENT = "pcf";
