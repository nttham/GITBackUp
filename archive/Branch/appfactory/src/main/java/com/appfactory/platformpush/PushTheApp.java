...
//	public ArrayList<String> checkFortheplatform(final String what_platform, final String appname, String url) {
//		String endpoint=url;
//		String host;
//		String appurl;
...
//			host =  Messages.getString("Pivotal_API_EndPoint_Host");
//			break;
//		case "2002":
...
//	public String checkFortheplatform(String whatplatform, String url, String appname, JSONObject appresponse, String zippath,
...
//	}
	String token=null;
	String appguid=null;
	public String createApp(String appname, JSONObject response, String zippath, 	String messageID,String platformurl,String gistid) throws MyException {
		...
		try {
			...
			jobj.put("memory",ApplicationConstants.APP_MEMORY);
			...
			su.updatestatus(this.messageid,this.gistid,sendExceptionmsg(conn, e), ApplicationConstants.CFURL, 102,ApplicationConstants.LOG_LEVEL_ERROR);
			throw utils.myException(CustomErrorMessage.CREATE_APP_ERROR, sendExceptionmsg(conn, e));
		}
	...
	private String getDomains(JSONObject jsonObject, String zippath, String platformurl) throws MyException {
		...
		try {
			...
			throw utils.myException(CustomErrorMessage.CREATE_DOMAIN_ERROR, sendExceptionmsg(conn, e));
		}
	}
	...
	private String createRoute(JSONObject jsonObject, String zippath, String platformurl) throws MyException {
		...
		try {
			...
			su.updatestatus(this.messageid,this.gistid, ApplicationConstants.PLATFORM_CREATEROUTE_ERROR, ApplicationConstants.CFURL, 102,ApplicationConstants.LOG_LEVEL_ERROR);
			throw utils.myException(CustomErrorMessage.CREATE_ROUTE_ERROR, sendExceptionmsg(conn, e));
		}
	}
	...
	public String startApplication(String token, String appguid, String platformurl, String domainguid) throws MyException {
		...
		try {
			...
			if(responseObj.has("status")){
				...
				su.updatestatus(this.messageid,this.gistid, ApplicationConstants.STARTING_ERROR, ApplicationConstants.CFURL, 101,ApplicationConstants.LOG_LEVEL_ERROR);
			}else{
			...
			su.updatestatus(this.messageid,this.gistid, ApplicationConstants.STARTING_ERROR, ApplicationConstants.CFURL, 102,ApplicationConstants.LOG_LEVEL_ERROR);
			throw utils.myException(CustomErrorMessage.START_APP_ERROR, sendExceptionmsg(conn, e));
		}
	}
}
