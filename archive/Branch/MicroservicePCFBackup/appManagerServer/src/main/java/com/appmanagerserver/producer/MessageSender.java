...
public class MessageSender {
	 ...
	 */
		 ...
		 * @throws MyException
		 */
		@RequestMapping(value = ApplicationConstants.SAVE_STATUS+"/{messageId}/{gistId}", method = RequestMethod.POST,headers="Accept=application/json")
		@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = Result.class),
		         @ApiResponse(code = 401, message = "Unauthorized"), 
		         @ApiResponse(code = 500, message = "Failure") })
		 ...
		 * @throws MyException
		 */
		@RequestMapping(value = ApplicationConstants.SAVE_STATUS+"/{messageId}", method = RequestMethod.GET,headers="Accept=application/json")
		@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = Result.class),
		         @ApiResponse(code = 401, message = "Unauthorized"), 
		         @ApiResponse(code = 500, message = "Failure") })
		 ...
		 * @throws MyException
		 */
		@RequestMapping(value = ApplicationConstants.DOWNLOAD+"/{messageId}", method = RequestMethod.GET,headers="Accept=application/json")
		@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = Result.class),
		         @ApiResponse(code = 401, message = "Unauthorized"), 
		         @ApiResponse(code = 500, message = "Failure") })
